 ...
 */
final class Version20230222113803 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE association DROP association_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE association ADD association_id LONGTEXT NOT NULL');
    }
}
